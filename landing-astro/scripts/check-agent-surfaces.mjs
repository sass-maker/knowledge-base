...
if (
  surface.url !== "https://knowledgebase.sassmaker.com/" ||
  surface.md !== "https://knowledgebase.sassmaker.com/index.md"
) {
...
if (
  ...
  sitemapLocations[0] !== "https://knowledgebase.sassmaker.com/"
) {
...
const publicOutput = (
  await Promise.all(requiredFiles.map((requiredFile) => read(requiredFile)))
).join("\n");
